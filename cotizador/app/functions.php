...
function set_client($client) {
  ...
  $_SESSION['new_quote']['project']       = trim($client['proyecto']);
  $_SESSION['new_quote']['noquote']      = trim($client['nocoti']);
  return true;
}
...
function hook_add_to_quote() {
  // Validar
  if(!isset($_POST['concepto'], $_POST['marca'], $_POST['tipo'], $_POST['precio_unitario'], $_POST['cantidad'])) {
...
function hook_save_concept() {
  // Validar
  if(!isset($_POST['id_concepto'], $_POST['concepto'], $_POST['marca'], $_POST['tipo'], $_POST['precio_unitario'], $_POST['cantidad'])) {
    json_output(json_build(403, null, 'Parametros incompletos.'));
  }
...
function hook_generate_quote() {
  // Validar
  if(!isset($_POST['nombre'], $_POST['empresa'], $_POST['email'], $_POST['proyecto'], $_POST['nocoti'])) {
    json_output(json_build(403, null, 'Paráaametros incompletos.'));
  }
